...
pub mod random_sampling_storage;
pub mod sharding;
pub mod staking;
pub mod token;
...
pub use delegators_info::DelegatorsInfo;
pub use hub::Hub;
pub use identity::Identity;
pub use identity_storage::IdentityStorage;
pub use kc_storage::KnowledgeCollectionStorage;
pub use multicall::Multicall3;
pub use params::ParametersStorage;
pub use paranet::{Paranet, ParanetsRegistry, PermissionedNode};
pub use profile::Profile;
pub use random_sampling::RandomSampling;
pub use random_sampling_storage::RandomSamplingStorage;
pub use sharding::{ShardingTable, ShardingTableLib, ShardingTableStorage};
...
impl Contracts {
    ...
    pub fn knowledge_collection_storage_by_address(
        &self,
        address: &Address,
    ...
    pub fn chronos(&self) -> &Chronos::ChronosInstance<BlockchainProvider> {
        &self.chronos
    }
    ...
    pub fn random_sampling(&self) -> &RandomSampling::RandomSamplingInstance<BlockchainProvider> {
        &self.random_sampling
    }

    pub fn random_sampling_storage(
        &self,
    ) -> &RandomSamplingStorage::RandomSamplingStorageInstance<BlockchainProvider> {
        &self.random_sampling_storage
    }

    pub fn delegators_info(&self) -> &DelegatorsInfo::DelegatorsInfoInstance<BlockchainProvider> {
    ...
    pub fn get_all_addresses(&self, contract_name: &ContractName) -> Vec<Address> {
        match contract_name {
