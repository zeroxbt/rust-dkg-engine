...
impl EvmChain {
    ...
    ///
    /// ```ignore
    /// use crate::multicall::{MulticallBatch, MulticallRequest, encoders};
    ///
    ...
    pub async fn execute_multicall(
        &self,
        batch: crate::multicall::MulticallBatch,
    ) -> Result<Vec<crate::multicall::MulticallResult>, BlockchainError> {
        use crate::multicall::MulticallResult;
    ...
    ) -> Vec<crate::multicall::MulticallResult> {
        use crate::multicall::MulticallResult;
