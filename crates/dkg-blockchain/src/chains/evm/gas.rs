...
impl GasConfig {
    ...
    pub fn bump_wei(&self, current: U256) -> Option<U256> {
...
impl FeeQuote {
    pub fn bump(&self, gas_config: &GasConfig) -> Option<Self> {
        match self {
...
impl EvmChain {
    pub async fn get_fee_quote(&self) -> FeeQuote {
