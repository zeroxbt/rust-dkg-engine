...
pub(crate) struct ParanetKcSyncRepository {
...
impl ParanetKcSyncRepository {
    ...
    pub(crate) async fn count_discovered(&self, paranet_ual: &str) -> Result<u64> {
        Entity::find()
    ...
    pub(crate) async fn enqueue_locators(
        &self,
        paranet_ual: &str,
        blockchain_id: &str,
        paranet_id: &str,
    ...
    pub(crate) async fn get_due_pending_batch(
        &self,
        blockchain_id: &str,
        paranet_ual: &str,
        now_ts: i64,
    ...
    pub(crate) async fn mark_synced(&self, paranet_ual: &str, kc_ual: &str) -> Result<()> {
        let now = Utc::now().timestamp();
    ...
    pub(crate) async fn mark_failed_attempt(
        &self,
        paranet_ual: &str,
        kc_ual: &str,
        now_ts: i64,
